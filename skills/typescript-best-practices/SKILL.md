...
description: Provides TypeScript patterns for type-first development, making illegal states unrepresentable, exhaustive handling, and runtime validation. Use when reading or writing TypeScript/JavaScript files.
---
...
This skill covers TypeScript fundamentals for services, models, and utilities. For Angular-specific patterns (components, signals, reactive forms), see the project CLAUDE.md and cfp-development-practices skill.
